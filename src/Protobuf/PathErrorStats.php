...
class PathErrorStats extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \GraphQlTools\Protobuf\PathErrorStats::class);
        $this->children = $arr;
