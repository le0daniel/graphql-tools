...
class Report extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \GraphQlTools\Protobuf\ReportHeader $header
    ...
    /**
     * Generated from protobuf field <code>.ReportHeader header = 1;</code>
     * @return \GraphQlTools\Protobuf\ReportHeader|null
     */
    ...
    /**
     * Generated from protobuf field <code>.ReportHeader header = 1;</code>
     * @param \GraphQlTools\Protobuf\ReportHeader $var
     * @return $this
     */
    public function setHeader($var)
    {
        GPBUtil::checkMessage($var, \GraphQlTools\Protobuf\ReportHeader::class);
        $this->header = $var;
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \GraphQlTools\Protobuf\TracesAndStats::class);
