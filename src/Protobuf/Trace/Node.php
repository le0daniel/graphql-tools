...
class Node extends \Google\Protobuf\Internal\Message
{
     ...
     *           relative to the trace's start_time, in ns
     *     @type \GraphQlTools\Protobuf\Trace\Error[]|\Google\Protobuf\Internal\RepeatedField $error
     *     @type \GraphQlTools\Protobuf\Trace\Node[]|\Google\Protobuf\Internal\RepeatedField $child
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .Trace.Error error = 11;</code>
     * @param \GraphQlTools\Protobuf\Trace\Error[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setError($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \GraphQlTools\Protobuf\Trace\Error::class);
        $this->error = $arr;
    ...
    /**
     * Generated from protobuf field <code>repeated .Trace.Node child = 12;</code>
     * @param \GraphQlTools\Protobuf\Trace\Node[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setChild($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \GraphQlTools\Protobuf\Trace\Node::class);
        $this->child = $arr;
