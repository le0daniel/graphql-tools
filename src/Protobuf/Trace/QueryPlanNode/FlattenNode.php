...
namespace GraphQlTools\Protobuf\Trace\QueryPlanNode;
...
class FlattenNode extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \GraphQlTools\Protobuf\Trace\QueryPlanNode\ResponsePathElement[]|\Google\Protobuf\Internal\RepeatedField $response_path
     *     @type \GraphQlTools\Protobuf\Trace\QueryPlanNode $node
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .Trace.QueryPlanNode.ResponsePathElement response_path = 1;</code>
     * @param \GraphQlTools\Protobuf\Trace\QueryPlanNode\ResponsePathElement[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResponsePath($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \GraphQlTools\Protobuf\Trace\QueryPlanNode\ResponsePathElement::class);
