...
class Type extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $name
     *           required; eg "User" for User.email:String!
     *     @type \Protobuf\Field[]|\Google\Protobuf\Internal\RepeatedField $field
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .Field field = 2;</code>
     * @param \Protobuf\Field[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setField($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Protobuf\Field::class);
        $this->field = $arr;
