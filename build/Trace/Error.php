...
class Error extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $message
     *           required
     *     @type \Trace\Location[]|\Google\Protobuf\Internal\RepeatedField $location
    ...
    /**
     * Generated from protobuf field <code>repeated .Trace.Location location = 2;</code>
     * @param \Trace\Location[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setLocation($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Trace\Location::class);
        $this->location = $arr;
