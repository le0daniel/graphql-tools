...
class Node extends \Google\Protobuf\Internal\Message
{
     ...
     *           The field's parent type; e.g. "User" for User.email:String!
     *     @type \Trace\CachePolicy $cache_policy
     *     @type int|string $start_time
     *           relative to the trace's start_time, in ns
     *     @type int|string $end_time
     *           relative to the trace's start_time, in ns
     *     @type \Trace\Error[]|\Google\Protobuf\Internal\RepeatedField $error
     *     @type \Trace\Node[]|\Google\Protobuf\Internal\RepeatedField $child
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .Trace.Error error = 11;</code>
     * @param \Trace\Error[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setError($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Trace\Error::class);
        $this->error = $arr;
    ...
    /**
     * Generated from protobuf field <code>repeated .Trace.Node child = 12;</code>
     * @param \Trace\Node[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setChild($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Trace\Node::class);
        $this->child = $arr;
