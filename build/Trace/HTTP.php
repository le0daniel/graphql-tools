...
class HTTP extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Protobuf\Trace\HTTP\Method::class);
        $this->method = $var;
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Protobuf\Trace\HTTP\Values::class);
